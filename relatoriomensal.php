...
<head>
  ...
  <title>Unifacema - Relatório Mensal CCEE</title>
...
<div id="right-panel" class="right-panel">
  ...
  <div class="content mt-3">
    <div class="animated fadeIn">
        <div class="row">
          <div class="col-lg-12">
            <div class="card card-form-relatorio-mes" style="margin-bottom: 0px">
              <div class="card-body">
                <form class="form-inline" id="formulario" method="post">
                  <div class="form-group mx-sm-6 mb-2">
                    ...
                    <input type="date" class="form-control campo-data" id="dataini" name="dataini" placeholder="">
                  </div>
                  <div class="form-group mx-sm-6 mb-2">
                    <label for="Data" class="sr-only">Data Final</label>
                    <input type="date" class="form-control campo-data" id="datafim" name="datafim" placeholder="">
                  </div>
